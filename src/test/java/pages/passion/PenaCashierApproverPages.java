...
public class PenaCashierApproverPages extends ReusableLibrary {
    ...
    {
        return By.xpath("//span[text()='"+referenceNumber+"']/..");
    }
    ...
    By btn_Ok_Data_Approval_OriginatingUnit=By.xpath("//div[text()='Data Approval Dikirim Ke Unit Asalnya!']/../../../descendant::span[text()='Ok']/..");
